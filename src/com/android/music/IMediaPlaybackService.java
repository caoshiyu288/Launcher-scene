 ...
 * Original file: /media/A6E85019E84FE661/6517_ICS/packages/apps/Music/src/com/android/music/IMediaPlaybackService.aidl
 */
...
case TRANSACTION_getTrackFilePathName:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _result = this.getTrackFilePathName();
reply.writeNoException();
reply.writeString(_result);
return true;
}
...
public java.lang.String getTrackFilePathName() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getTrackFilePathName, _data, _reply, 0);
_reply.readException();
_result = _reply.readString();
}
finally {
...
static final int TRANSACTION_getTrackFilePathName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
...
static final int TRANSACTION_getMIMEType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
