...
public class ArcShortTranslateAnimation extends Animation {
	 ...
	 */
	public ArcShortTranslateAnimation(float fromXDelta, float toXDelta,
	 ...
	 *            ABSOLUTE, or a percentage (where 1.0 is 100%) otherwise.
	 */
	public ArcShortTranslateAnimation(int fromXType, float fromXValue, int toXType,
