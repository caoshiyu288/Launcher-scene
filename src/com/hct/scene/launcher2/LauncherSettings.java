...
class LauncherSettings {
    static interface BaseLauncherColumns extends BaseColumns {
        ...
        /**
         * the gesture is an widget furniture for house UI
         * */
        static final int ITEM_TYPE_FURNITURE = 6;

        /**
         * The gesture is an application created preshortcut
         */       
        static final int ITEM_TYPE_PRE_SHORTCUT = 5;        
         ...
         * for house ui
         */
        static final String FURNITURE_CLASS = "furnitureClass";
        
        static final String FURNITURE_STYLE = "furnitureStyle";
    ...
    static final class Favorites implements BaseLauncherColumns {
        ...
        static final int CONTAINER_HOUSE = -102;

        /* added by hct lijunyi, 20130128 */
        static final int CONTAINER_BOOKSHELF = -103;
        /* end of added by hct lijunyi, 20130128 */
