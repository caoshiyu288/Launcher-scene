...
final class Utilities {
    ...
    static public Bitmap createCompoundBitmap(Bitmap bgBitmap, Bitmap iconBitmap) {
        ...
        final Bitmap icon = scaleBitmap(iconBitmap, dx, dy);
    ...
    public static Bitmap compositeImages(Bitmap src, Bitmap dst) {
        Paint paint = new Paint();
        Canvas canvas = new Canvas(src);
        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OVER)); // DST_ATOP
